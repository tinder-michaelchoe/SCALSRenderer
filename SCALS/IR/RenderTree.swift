...
// NOTE: IR.ActionDefinition has been extracted to ActionDefinition.swift for better organization.
// The action system uses a fully dynamic dictionary-based approach for maximum extensibility.
