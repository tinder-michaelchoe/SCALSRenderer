...
public struct CSSGenerator {
    ...
    public mutating func generate(from tree: RenderTree) -> String {
        ...
        var css = "/* Generated CLADS Styles */\n\n"
    ...
    private mutating func generateContainerClassName(for id: String?) -> String {
        containerCounter += 1
        if let id = id {
            return "clads-container-\(id.cssClassName)"
        }
        return "clads-container-\(containerCounter)"
    }
    
    private mutating func generateTextClassName(for id: String?) -> String {
        textCounter += 1
        if let id = id {
            return "clads-text-\(id.cssClassName)"
        }
        return "clads-text-\(textCounter)"
    }
    
    private mutating func generateButtonClassName(for id: String?) -> String {
        buttonCounter += 1
        if let id = id {
            return "clads-button-\(id.cssClassName)"
        }
        return "clads-button-\(buttonCounter)"
    }
    
    private mutating func generateImageClassName(for id: String?) -> String {
        imageCounter += 1
        if let id = id {
            return "clads-image-\(id.cssClassName)"
        }
        return "clads-image-\(imageCounter)"
    }
    
    private mutating func generateTextFieldClassName(for id: String?) -> String {
        textFieldCounter += 1
        if let id = id {
            return "clads-textfield-\(id.cssClassName)"
        }
        return "clads-textfield-\(textFieldCounter)"
    }
    
    private mutating func generateToggleClassName(for id: String?) -> String {
        toggleCounter += 1
        if let id = id {
            return "clads-toggle-\(id.cssClassName)"
        }
        return "clads-toggle-\(toggleCounter)"
    }
    
    private mutating func generateSliderClassName(for id: String?) -> String {
        sliderCounter += 1
        if let id = id {
            return "clads-slider-\(id.cssClassName)"
        }
        return "clads-slider-\(sliderCounter)"
    }
    
    private mutating func generateGradientClassName(for id: String?) -> String {
        gradientCounter += 1
        if let id = id {
            return "clads-gradient-\(id.cssClassName)"
        }
    ...
    private mutating func generateDividerClassName(for id: String?) -> String {
        dividerCounter += 1
        if let id = id {
            return "clads-divider-\(id.cssClassName)"
        }
        return "clads-divider-\(dividerCounter)"
    }
    
    private mutating func generateSectionLayoutClassName(for id: String?) -> String {
        sectionLayoutCounter += 1
        if let id = id {
            return "clads-section-layout-\(id.cssClassName)"
        }
        return "clads-section-layout-\(sectionLayoutCounter)"
    }
}
