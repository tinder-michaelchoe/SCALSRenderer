...
public struct HTMLNodeRenderer {
    ...
    private mutating func containerClassName(for container: ContainerNode) -> String {
        ...
        if let id = container.id {
            classes.append("clads-container-\(id.cssClassName)")
        } else {
            classes.append("clads-container-\(containerCounter)")
        }
    ...
    private mutating func renderSectionLayout(_ sectionLayout: SectionLayoutNode) -> String {
        ...
        let className = sectionLayout.id.map { "clads-section-layout-\($0.cssClassName)" } ?? "clads-section-layout"
    ...
    private mutating func renderText(_ text: TextNode) -> String {
        ...
        textCounter += 1
        if let id = text.id {
            classes.append("clads-text-\(id.cssClassName)")
        } else {
            classes.append("clads-text-\(textCounter)")
        }
    ...
    private mutating func renderButton(_ button: ButtonNode) -> String {
        ...
        buttonCounter += 1
        if let id = button.id {
            classes.append("clads-button-\(id.cssClassName)")
        } else {
            classes.append("clads-button-\(buttonCounter)")
        }
    ...
    private func renderTextField(_ textField: TextFieldNode) -> String {
        ...
        if let id = textField.id {
            classes.append("clads-textfield-\(id.cssClassName)")
        }
    ...
    private func renderToggle(_ toggle: ToggleNode) -> String {
        ...
        if let id = toggle.id {
            classes.append("clads-toggle-\(id.cssClassName)")
        }
    ...
    private func renderSlider(_ slider: SliderNode) -> String {
        ...
        if let id = slider.id {
            classes.append("clads-slider-\(id.cssClassName)")
        }
    ...
    private mutating func renderImage(_ image: ImageNode) -> String {
        ...
        if let id = image.id {
            classes.append("clads-image-\(id.cssClassName)")
        }
    ...
    private func renderGradient(_ gradient: GradientNode) -> String {
        ...
        if let id = gradient.id {
            classes.append("clads-gradient-\(id.cssClassName)")
        }
    ...
    private func renderDivider(_ divider: DividerNode) -> String {
        ...
        if let id = divider.id {
            classes.append("clads-divider-\(id.cssClassName)")
        }
    ...
    private mutating func renderCustomNode(kind: RenderNodeKind, node: any CustomRenderNode) -> String {
        ...
        return """
        <div class="clads-custom clads-custom-\(kind.rawValue.cssClassName)" data-node-kind="\(kind.rawValue.htmlEscaped)">
