//
//  UIKitRendererConfiguration.swift
//  ScalsModules
//
//  Configuration struct for UIKit renderer initialization.
//

import SCALS

/// Configuration for ScalsViewController (UIKit).
///
...
///     rendererRegistry: customUIKitRegistry
/// )
/// ```
public struct UIKitRendererConfiguration {
    // MARK: - Registries
    ...
    public let rendererRegistry: UIKitNodeRendererRegistry
    ...
    ///   - rendererRegistry: Registry for UIKit node renderers
    ...
    public init(
        ...
        self.rendererRegistry = registries.uiKitRegistry
        self.customComponents = customComponents
        self.actionDelegate = actionDelegate
        self.designSystemProvider = designSystemProvider
        self.debugMode = debugMode
