...
/// Unified API for registering custom components in SCALS.
///
...
/// )
/// ```
public final class ScalsRegistry: @unchecked Sendable {
...
/// Example:
/// ```swift
/// struct ChartingPlugin: SCALSPlugin {
