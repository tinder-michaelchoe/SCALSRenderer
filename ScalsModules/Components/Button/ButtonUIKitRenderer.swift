...
public struct ButtonUIKitRenderer: UIKitNodeRendering {
    ...
    private func uiImagePlacement(_ placement: ButtonImagePlacement) -> NSDirectionalRectEdge {
        switch placement {
    ...
    private func resolveUIImage(_ source: ImageSource, context: UIKitRenderContext) -> UIImage? {
        switch source {
