...
// MARK: - Button SwiftUI Renderer

public struct ButtonSwiftUIRenderer: SwiftUINodeRendering {
...
struct ButtonNodeView: View {
    ...
    @ViewBuilder
    private func labelWithImage(_ imageSource: ImageSource) -> some View {
    ...
    @ViewBuilder
    private func resolveImage(_ source: ImageSource) -> some View {
        switch source {
