...
public struct ImageResolver: ComponentResolving {
    ...
    @MainActor
    private func resolveImageSource(_ component: Document.Component, context: ResolutionContext) -> ImageSource {
    ...
    private func resolvePlaceholder(_ component: Document.Component) -> ImageSource? {
    ...
    private func resolveLoading(_ component: Document.Component) -> ImageSource? {
    ...
    /// Resolves an ImagePlaceholder to an ImageSource
    private func resolveImagePlaceholder(_ placeholder: Document.ImagePlaceholder) -> ImageSource? {
        // SF Symbol
